package com.st.cleancode.student;
...
public class StudentHelper {
	...
	*/
    ...
    public String getGrade_(int mark, boolean isMaths) {

        int grade_A_Mark = 91;
        int grade_B_Mark = 51;
        int extraMarks = isMaths ? 5 : 0;

        if (mark >= grade_A_Mark + extraMarks)
            return  "A";
        else if (mark >= grade_B_Mark + extraMarks) {
            return  "B";
        }
        return "C";
    }
